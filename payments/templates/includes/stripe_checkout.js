...
class StripeCheckout {
	...
	create_payment_intent() {
		frappe.call({
			method:"payments.templates.pages.stripe_checkout.make_payment_intent",
			args: {
	...
	createSubscription({ customerId, paymentMethodId }) {
		return (
			frappe.call({
				method:"payments.templates.pages.stripe_checkout.make_subscription",
				args: {
					payment_key: this.payment_key,
	...
	retryInvoiceWithNewPaymentMethod({
		...
		return (
			frappe.call({
				method:"payments.templates.pages.stripe_checkout.retry_invoice",
				args: {
					payment_key: this.payment_key,
					customerId: customerId,
					paymentMethodId: paymentMethodId,
	...
	attachPaymentCard(result) {
		frappe.call({
			method:"payments.templates.pages.stripe_checkout.update_payment_method",
			args: {
				payment_key: this.payment_key,
				customerId: this.customer,
